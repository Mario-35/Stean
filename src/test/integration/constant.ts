...
let nb = 0;
export function getNB(message: string): string {
    nb += 1;
...
export const infos: Record<string, any> = {
    ...
    MultiDatastreamObservedProperties: {
        ...
        constraints: {
            ...
            multidatastreamobservedproperty_multidatastream_id_fkey: 'FOREIGN KEY ("multidatastream_id") REFERENCES "multidatastream"("id") ON UPDATE CASCADE ON DELETE CASCADE',
            multidatastreamobservedproperty_observedproperty_id_fkey: 'FOREIGN KEY ("observedproperty_id") REFERENCES "observedproperty"("id") ON UPDATE CASCADE ON DELETE CASCADE'
        },
        indexes: {
