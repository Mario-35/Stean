...
describe("Odata Built In Operators [9.3.3.5.1]", () => {
    ...
    it("Odata Built-in operator eq", (done) => {
        const infos = addTest({
            ...
            request: `${testVersion}/Observations?$filter=result eq 310`
        });
        chai.request(server)
    ...
    it("Odata Built-in operator ne", (done) => {
        const infos = addTest({
            ...
            reference: "https://docs.ogc.org/is/18-088/18-088.html#_built_in_filter_operations",
            request: `${testVersion}/Observations?$filter=result ne 45`
        });
        chai.request(server)
            .get(`/test/${infos.request}`)
            .end((err, res) => {
    ...
    it("Odata Built-in operator gt", (done) => {
        const infos = addTest({
            ...
            reference: "https://docs.ogc.org/is/18-088/18-088.html#_built_in_filter_operations",
            request: `${testVersion}/Observations?$filter=result gt 90`
        });
        chai.request(server)
            .get(`/test/${infos.request}`)
            .end((err, res) => {
    ...
    it("Odata Built-in operator gt AND lt", (done) => {
        const infos = addTest({
            ...
            description: "",
            reference: "",
            request: `${testVersion}/Observations?$filter=result gt 20 and result lt 22`
        });
        chai.request(server)
            .get(`/test/${infos.request}`)
            .end((err, res) => {
                ...
                res.status.should.equal(200);
                res.type.should.equal("application/json");
                res.body.value.length.should.eql(176);
                res.body.should.include.keys("@iot.count", "value");
                done();
            });
    });
    ...
    it("Odata Built-in operator ge", (done) => {
        const infos = addTest({
            ...
            reference: "https://docs.ogc.org/is/18-088/18-088.html#_built_in_filter_operations",
            request: `${testVersion}/Observations?$filter=result ge 90`
        });
        chai.request(server)
            .get(`/test/${infos.request}`)
            .end((err, res) => {
                ...
                res.status.should.equal(200);
                res.type.should.equal("application/json");
                res.body.value.length.should.eql(121);
                res.body.should.include.keys("@iot.count", "value");
                addToApiDoc({ ...infos, result: limitResult(res) });
    ...
    it("Odata Built-in operator lt", (done) => {
        const infos = addTest({
            ...
            reference: "https://docs.ogc.org/is/18-088/18-088.html#_built_in_filter_operations",
            request: `${testVersion}/Observations?$filter=result lt 90`
        });
        chai.request(server)
            .get(`/test/${infos.request}`)
            .end((err, res) => {
    ...
    it("Odata Built-in operator le", (done) => {
        const infos = addTest({
            ...
            reference: "https://docs.ogc.org/is/18-088/18-088.html#_built_in_filter_operations",
            request: `${testVersion}/Observations?$filter=result le 90`
        });
        chai.request(server)
            .get(`/test/${infos.request}`)
            .end((err, res) => {
                ...
                res.status.should.equal(200);
                res.type.should.equal("application/json");
                res.body.value.length.should.eql(411);
                res.body.should.include.keys("@iot.count", "value");
                addToApiDoc({ ...infos, result: limitResult(res) });
                done();
            });
    ...
    it("Odata Built-in operator or", (done) => {
        const infos = addTest({
            ...
            reference: "https://docs.ogc.org/is/18-088/18-088.html#_built_in_filter_operations",
            request: `${testVersion}/Things?$filter=name eq 'classic Thing' or description eq 'Description of Hack $debug=true Thing'`
        });
        chai.request(server)
            .get(`/test/${infos.request}`)
            .end((err, res) => {
