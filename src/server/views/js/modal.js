...
class Observation extends Component {
	...
	injectTemplate() {
		...
		let innerContainer = h('div', {
			class: 'obsInfos attributes'
		}, [
			h('dt', null, ["date"]),
