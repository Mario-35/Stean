...
import { Ientity, IreturnFormat, Iservice, koaContext } from "../types";
...
export const isReturn = (input: RootPgVisitor | PgVisitor, test: IreturnFormat[]) => (test.includes(input.returnFormat) ? true : undefined);
