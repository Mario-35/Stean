...
export const doubleQuotes = (input: string): string => `"${trimDoubleQuotes(input)}"`;
export const simpleQuotes = (input: string): string => `'${escapeSimpleQuotes(trimSimpleQuotes(input))}'`;
