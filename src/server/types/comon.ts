...
export interface Icomon {
    ...
    getSingle(id: number | bigint | string): Promise<IreturnResult | Iuser | undefined>; // get one item
    ...
    delete(id: number | bigint | string): Promise<IreturnResult | undefined>; // delete item
}
